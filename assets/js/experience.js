...
class job {
    constructor(title, company, company_description, date, location, description) {
        this.title = title;
...
const experience = {
    "developer": new job("Software Developer", "distrotek", "Front End Development Lab", "April 2022 - Present", "Ottawa, Ontario, Canada", [
    ...
    "treasurer": new job("Treasurer and Instructor", "UTM Boxing Club", "Non-Profit Organization", "October 2019 - May 2021", "Mississauga, Ontario, Canada", [
